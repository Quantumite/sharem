...
class PEB_LDR_DATA32:
    ...
    def allocate(
        self, mu, ilo_flink, ilo_blink, imo_flink, imo_blink, iio_flink, iio_blink
    ):
...
def allocateWinStructs32(mu, mods):
    ...
    peb_ldr.allocate(
        mu,
        dlls_obj[0].ILO_entry,
        dlls_obj[-1].ILO_entry,
        dlls_obj[0].IMO_entry,
        dlls_obj[-1].IMO_entry,
        dlls_obj[1].IIO_entry,
        dlls_obj[-1].IIO_entry,
    )
    ...
    dlls_obj[1].allocate(
        mu,
        dlls_obj[2].ILO_entry,
        dlls_obj[0].ILO_entry,
        dlls_obj[2].IMO_entry,
        dlls_obj[0].IMO_entry,
        dlls_obj[3].IIO_entry,
        dlls_obj[-1].IIO_entry,
    )
    dlls_obj[2].allocate(
        mu,
        dlls_obj[3].ILO_entry,
        dlls_obj[1].ILO_entry,
        dlls_obj[3].IMO_entry,
        dlls_obj[1].IMO_entry,
        dlls_obj[4].IIO_entry,
        dlls_obj[3].IIO_entry,
    )
    dlls_obj[3].allocate(
        mu,
        dlls_obj[4].ILO_entry,
        dlls_obj[2].ILO_entry,
        dlls_obj[4].IMO_entry,
        dlls_obj[2].IMO_entry,
        dlls_obj[2].IIO_entry,
        dlls_obj[1].IIO_entry,
    )
    dlls_obj[4].allocate(
        mu,
        dlls_obj[5].ILO_entry,
        dlls_obj[3].ILO_entry,
        dlls_obj[5].IMO_entry,
        dlls_obj[3].IMO_entry,
        dlls_obj[5].IIO_entry,
        dlls_obj[2].IIO_entry,
    )
        ...
        # Inflate dlls so PE offsets are correct
            ...
            for exp in pe.DIRECTORY_ENTRY_EXPORT.symbols:
                try:
                    ...
                    export_dict[hex(base + exp.address)] = (
                        "unknown_function",
                        dll_file,
                    )
        else:
...
def initMods(uc, em, export_dict, source_path, save_path):
    ...
    export_dict, mods, mod_high_val = iter_and_dump_dlls(

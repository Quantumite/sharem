...
class timelessD:
    ...
    def giveVal2(self, uc, esp, memReadVal):
        self.esp_neg_0xa0 = int.from_bytes(
            uc.mem_read(esp - 0xA0, memReadVal), "little"
        )
        self.esp_neg_0x9c = int.from_bytes(
            uc.mem_read(esp - 0x9C, memReadVal), "little"
        )
        self.esp_neg_0x98 = int.from_bytes(
            uc.mem_read(esp - 0x98, memReadVal), "little"
        )
        self.esp_neg_0x94 = int.from_bytes(
            uc.mem_read(esp - 0x94, memReadVal), "little"
        )
        self.esp_neg_0x90 = int.from_bytes(
            uc.mem_read(esp - 0x90, memReadVal), "little"
        )
        self.esp_neg_0x8c = int.from_bytes(
            uc.mem_read(esp - 0x8C, memReadVal), "little"
        )
        self.esp_neg_0x88 = int.from_bytes(
            uc.mem_read(esp - 0x88, memReadVal), "little"
        )
        self.esp_neg_0x84 = int.from_bytes(
            uc.mem_read(esp - 0x84, memReadVal), "little"
        )
        self.esp_neg_0x80 = int.from_bytes(
            uc.mem_read(esp - 0x80, memReadVal), "little"
        )
        self.esp_neg_0x7c = int.from_bytes(
            uc.mem_read(esp - 0x7C, memReadVal), "little"
        )
        self.esp_neg_0x78 = int.from_bytes(
            uc.mem_read(esp - 0x78, memReadVal), "little"
        )
        self.esp_neg_0x74 = int.from_bytes(
            uc.mem_read(esp - 0x74, memReadVal), "little"
        )
        self.esp_neg_0x70 = int.from_bytes(
            uc.mem_read(esp - 0x70, memReadVal), "little"
        )
        self.esp_neg_0x6c = int.from_bytes(
            uc.mem_read(esp - 0x6C, memReadVal), "little"
        )
        self.esp_neg_0x68 = int.from_bytes(
            uc.mem_read(esp - 0x68, memReadVal), "little"
        )
        self.esp_neg_0x64 = int.from_bytes(
            uc.mem_read(esp - 0x64, memReadVal), "little"
        )
        self.esp_neg_0x60 = int.from_bytes(
            uc.mem_read(esp - 0x60, memReadVal), "little"
        )
        self.esp_neg_0x5c = int.from_bytes(
            uc.mem_read(esp - 0x5C, memReadVal), "little"
        )
        self.esp_neg_0x58 = int.from_bytes(
            uc.mem_read(esp - 0x58, memReadVal), "little"
        )
        self.esp_neg_0x54 = int.from_bytes(
            uc.mem_read(esp - 0x54, memReadVal), "little"
        )
        self.esp_neg_0x50 = int.from_bytes(
            uc.mem_read(esp - 0x50, memReadVal), "little"
        )
        self.esp_neg_0x4c = int.from_bytes(
            uc.mem_read(esp - 0x4C, memReadVal), "little"
        )
        self.esp_neg_0x48 = int.from_bytes(
            uc.mem_read(esp - 0x48, memReadVal), "little"
        )
        self.esp_neg_0x44 = int.from_bytes(
            uc.mem_read(esp - 0x44, memReadVal), "little"
        )
        self.esp_neg_0x40 = int.from_bytes(
            uc.mem_read(esp - 0x40, memReadVal), "little"
        )
        self.esp_neg_0x3c = int.from_bytes(
            uc.mem_read(esp - 0x3C, memReadVal), "little"
        )
        self.esp_neg_0x38 = int.from_bytes(
            uc.mem_read(esp - 0x38, memReadVal), "little"
        )
        self.esp_neg_0x34 = int.from_bytes(
            uc.mem_read(esp - 0x34, memReadVal), "little"
        )
        self.esp_neg_0x30 = int.from_bytes(
            uc.mem_read(esp - 0x30, memReadVal), "little"
        )
        self.esp_neg_0x2c = int.from_bytes(
            uc.mem_read(esp - 0x2C, memReadVal), "little"
        )
        self.esp_neg_0x28 = int.from_bytes(
            uc.mem_read(esp - 0x28, memReadVal), "little"
        )
        self.esp_neg_0x24 = int.from_bytes(
            uc.mem_read(esp - 0x24, memReadVal), "little"
        )
        self.esp_neg_0x20 = int.from_bytes(
            uc.mem_read(esp - 0x20, memReadVal), "little"
        )
        self.esp_neg_0x1c = int.from_bytes(
            uc.mem_read(esp - 0x1C, memReadVal), "little"
        )
        self.esp_neg_0x18 = int.from_bytes(
            uc.mem_read(esp - 0x18, memReadVal), "little"
        )
        self.esp_neg_0x14 = int.from_bytes(
            uc.mem_read(esp - 0x14, memReadVal), "little"
        )
        self.esp_neg_0x10 = int.from_bytes(
            uc.mem_read(esp - 0x10, memReadVal), "little"
        )
    ...
    def giveVal2_64(self, uc, rsp, memReadVal):
        self.rsp_neg_0xa0 = int.from_bytes(
            uc.mem_read(rsp - 0xA0, memReadVal), "little"
        )
        self.rsp_neg_0x98 = int.from_bytes(
            uc.mem_read(rsp - 0x98, memReadVal), "little"
        )
        self.rsp_neg_0x90 = int.from_bytes(
            uc.mem_read(rsp - 0x90, memReadVal), "little"
        )
        self.rsp_neg_0x88 = int.from_bytes(
            uc.mem_read(rsp - 0x88, memReadVal), "little"
        )
        self.rsp_neg_0x80 = int.from_bytes(
            uc.mem_read(rsp - 0x80, memReadVal), "little"
        )
        self.rsp_neg_0x78 = int.from_bytes(
            uc.mem_read(rsp - 0x78, memReadVal), "little"
        )
        self.rsp_neg_0x70 = int.from_bytes(
            uc.mem_read(rsp - 0x70, memReadVal), "little"
        )
        self.rsp_neg_0x68 = int.from_bytes(
            uc.mem_read(rsp - 0x68, memReadVal), "little"
        )
        self.rsp_neg_0x60 = int.from_bytes(
            uc.mem_read(rsp - 0x60, memReadVal), "little"
        )
        self.rsp_neg_0x58 = int.from_bytes(
            uc.mem_read(rsp - 0x58, memReadVal), "little"
        )
        self.rsp_neg_0x50 = int.from_bytes(
            uc.mem_read(rsp - 0x50, memReadVal), "little"
        )
        self.rsp_neg_0x48 = int.from_bytes(
            uc.mem_read(rsp - 0x48, memReadVal), "little"
        )
        self.rsp_neg_0x40 = int.from_bytes(
            uc.mem_read(rsp - 0x40, memReadVal), "little"
        )
        self.rsp_neg_0x38 = int.from_bytes(
            uc.mem_read(rsp - 0x38, memReadVal), "little"
        )
        self.rsp_neg_0x30 = int.from_bytes(
            uc.mem_read(rsp - 0x30, memReadVal), "little"
        )
        self.rsp_neg_0x28 = int.from_bytes(
            uc.mem_read(rsp - 0x28, memReadVal), "little"
        )
        self.rsp_neg_0x20 = int.from_bytes(
            uc.mem_read(rsp - 0x20, memReadVal), "little"
        )
        self.rsp_neg_0x18 = int.from_bytes(
            uc.mem_read(rsp - 0x18, memReadVal), "little"
        )
        self.rsp_neg_0x10 = int.from_bytes(
            uc.mem_read(rsp - 0x10, memReadVal), "little"
        )
...
def giveStackClass(uc, arch, pc, asssemblyInst):
    ...
    if arch == 32:
        ...
        memReadVal = 4
        ESPs = {
            "esp-0xa0": int.from_bytes(uc.mem_read(esp - 0xA0, 4), "little"),
            "esp-0x9c": int.from_bytes(uc.mem_read(esp - 0x9C, 4), "little"),
            "esp-0x98": int.from_bytes(uc.mem_read(esp - 0x98, 4), "little"),
            "esp-0x94": int.from_bytes(uc.mem_read(esp - 0x94, 4), "little"),
            "esp-0x90": int.from_bytes(uc.mem_read(esp - 0x90, 4), "little"),
            "esp-0x8c": int.from_bytes(uc.mem_read(esp - 0x8C, 4), "little"),
            "esp-0x88": int.from_bytes(uc.mem_read(esp - 0x88, 4), "little"),
            "esp-0x84": int.from_bytes(uc.mem_read(esp - 0x84, 4), "little"),
            "esp-0x80": int.from_bytes(uc.mem_read(esp - 0x80, 4), "little"),
            "esp-0x7c": int.from_bytes(uc.mem_read(esp - 0x7C, 4), "little"),
            "esp-0x78": int.from_bytes(uc.mem_read(esp - 0x78, 4), "little"),
            "esp-0x74": int.from_bytes(uc.mem_read(esp - 0x74, 4), "little"),
            "esp-0x70": int.from_bytes(uc.mem_read(esp - 0x70, 4), "little"),
            "esp-0x6c": int.from_bytes(uc.mem_read(esp - 0x6C, 4), "little"),
            "esp-0x68": int.from_bytes(uc.mem_read(esp - 0x68, 4), "little"),
            "esp-0x64": int.from_bytes(uc.mem_read(esp - 0x64, 4), "little"),
            "esp-0x60": int.from_bytes(uc.mem_read(esp - 0x60, 4), "little"),
            "esp-0x5c": int.from_bytes(uc.mem_read(esp - 0x5C, 4), "little"),
            "esp-0x58": int.from_bytes(uc.mem_read(esp - 0x58, 4), "little"),
            "esp-0x54": int.from_bytes(uc.mem_read(esp - 0x54, 4), "little"),
            "esp-0x50": int.from_bytes(uc.mem_read(esp - 0x50, 4), "little"),
            "esp-0x4c": int.from_bytes(uc.mem_read(esp - 0x4C, 4), "little"),
            "esp-0x48": int.from_bytes(uc.mem_read(esp - 0x48, 4), "little"),
            "esp-0x44": int.from_bytes(uc.mem_read(esp - 0x44, 4), "little"),
            "esp-0x40": int.from_bytes(uc.mem_read(esp - 0x40, 4), "little"),
            "esp-0x3c": int.from_bytes(uc.mem_read(esp - 0x3C, 4), "little"),
            "esp-0x38": int.from_bytes(uc.mem_read(esp - 0x38, 4), "little"),
            "esp-0x34": int.from_bytes(uc.mem_read(esp - 0x34, 4), "little"),
            "esp-0x30": int.from_bytes(uc.mem_read(esp - 0x30, 4), "little"),
            "esp-0x2c": int.from_bytes(uc.mem_read(esp - 0x2C, 4), "little"),
            "esp-0x28": int.from_bytes(uc.mem_read(esp - 0x28, 4), "little"),
            "esp-0x24": int.from_bytes(uc.mem_read(esp - 0x24, 4), "little"),
            "esp-0x20": int.from_bytes(uc.mem_read(esp - 0x20, 4), "little"),
            "esp-0x1c": int.from_bytes(uc.mem_read(esp - 0x1C, 4), "little"),
            "esp-0x18": int.from_bytes(uc.mem_read(esp - 0x18, 4), "little"),
            "esp-0x14": int.from_bytes(uc.mem_read(esp - 0x14, 4), "little"),
            "esp-0x10": int.from_bytes(uc.mem_read(esp - 0x10, 4), "little"),
            "esp-0xc": int.from_bytes(uc.mem_read(esp - 0xC, 4), "little"),
            "esp-0x8": int.from_bytes(uc.mem_read(esp - 8, 4), "little"),
            "esp-0x4": int.from_bytes(uc.mem_read(esp - 4, 4), "little"),
            "esp     ": int.from_bytes(uc.mem_read(esp, 4), "little"),
            "esp+0x4": int.from_bytes(uc.mem_read(esp + 4, 4), "little"),
            "esp+0x8": int.from_bytes(uc.mem_read(esp + 8, 4), "little"),
            "esp+0xc": int.from_bytes(uc.mem_read(esp + 0xC, 4), "little"),
            "esp+0x10": int.from_bytes(uc.mem_read(esp + 0x10, 4), "little"),
        ...
        memReadVal = 8
        RSPs = {
            "rsp-0xa0": int.from_bytes(uc.mem_read(rsp - 0xA0, 8), "little"),
            ...
            "rsp-0x30": int.from_bytes(uc.mem_read(rsp - 0x30, 8), "little"),
    ...
    for regName, regConst in stackVals:
        ...
        try:
            if t % numGroupings == 0 or t == 0:
                instructLine += f"\t{regName} > " + "{0:x}: ".format(
                    start + (t * memSize)
                )
...
def controlFlow(uc, mnemonic, op_str):
    ...
    controlFlow = re.match(
        "^((jmp)|(ljmp)|(jo)|(jno)|(jsn)|(js)|(je)|(jz)|(jne)|(jnz)|(jb)|(jnae)|(jc)|(jnb)|(jae)|(jnc)|(jbe)|(jna)|(ja)|(jnben)|(jl)|(jnge)|(jge)|(jnl)|(jle)|(jng)|(jg)|(jnle)|(jp)|(jpe)|(jnp)|(jpo)|(jczz)|(jecxz)|(jmp)|(jns)|(call)|(syscall))",
        mnemonic,
        re.M | re.I,
    )
